...
function Arcs(storage, ctl, editor, view)
{
    ...
    Arc.prototype = 
    {
        ctor: "Arc", 
        dep: ["p1", "p2"],
        toJSON: function(getId){return {p1:getId(this.p1), p2:getId(this.p2), a: this.a * 180 / Math.PI, _:"Arc"};},
    ...
    var pt = null, obj = null, Pt = storage.ctors["Point"], ctor = Arc;
